...
// $ANTLR 3.4 SugarCpp.g 2013-05-18 10:31:18
	...
	private AstParserRuleReturnScope<CommonTree, IToken> func_def()
	{
		...
		try
		{
			...
			case 1:
				...
				{
				// AST REWRITE
				// elements: generic_parameter, ident, func_args, stmt_block, 160, type_name, attribute
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
			...
			case 2:
				...
				{
				// AST REWRITE
				// elements: attribute, func_args, ident, 160, expr, type_name, generic_parameter
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
		...
		try
		{
			...
			case 1:
				...
				case 2:
					...
					{
					// AST REWRITE
					// elements: b, cmp_expr, 103, chain_list
					// token labels: 
					// rule labels: retval, b
					// token list labels: 
					// rule list labels: 
